...
import { faChevronRight, faChevronDown, faEyeSlash, faEye, faSearch } from '@fortawesome/free-solid-svg-icons'
import { FontAwesomeIcon } from '@fortawesome/vue-fontawesome'

library.add(faChevronRight, faChevronDown, faEye, faEyeSlash, faSearch);
